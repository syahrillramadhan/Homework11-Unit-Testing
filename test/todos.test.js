...
describe("Todo API", () => {
  ...
  it("should update a todo successfully", async () => {
    ...
    expect(response.body.updatedTodo).toHaveProperty(
      "title",
      "Update todo abangkuhh"
    );
  });
  ...
  it("should not update a non-existing todo", async () => {
    const updateData = {
      ...
      description:
        "This todo does not exist (student lain pakai basa enggres aku juga tipis2)",
      dueDate: "2024-06-20T12:00:00Z",
    };
  ...
  it("should not update a todo with an existing title", async () => {
    const todoData = {
      ...
      description:
        "This todo has an existing title (enggres lagi lah biar cakep)",
      dueDate: "2024-06-15T12:00:00Z",
    };
